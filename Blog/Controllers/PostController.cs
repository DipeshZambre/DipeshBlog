...
namespace Blog.Controllers
{
    public class PostController : Controller
    {
        ...
        { 
            ...
            {
                postQuery = postQuery.Where(p => p.CategoryId == categotyId);
            }
        ...
        public async Task<IActionResult> Edit(EditViewModel editViewModel)
        {
            ...
            if(editViewModel.FeatureImage != null)
            {
                ...
                // postFormDb.FeatureImagePath = await UploadFiletoFolder(editViewModel.FeatureImage);
        ...
        //public JsonResult AddComment([FromForm] Comment comment)
        //{
        ...
        private async Task<string> UploadFiletoFolder(IFormFile file)
        {
            ...
            {
                return "Error Uploading Merror:"+ ex.Message;
            }
